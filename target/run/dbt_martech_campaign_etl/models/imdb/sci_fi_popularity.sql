    ...
    create or replace table `the-field-448907-r6`.`my_imdb`.`sci_fi_popularity`
      
    
    

    OPTIONS(
      description="""Tracks the number of Sci-Fi movies released per year and their average rating over the last 50 years."""
    )
    as (
