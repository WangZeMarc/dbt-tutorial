    ...
    create or replace table `the-field-448907-r6`.`my_imdb`.`high_rated_genres`
      
    
    

    OPTIONS(
      description="""Analyzes which movie genres consistently receive high ratings over different time periods."""
    )
    as (
