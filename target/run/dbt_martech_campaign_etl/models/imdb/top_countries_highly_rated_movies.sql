    ...
    create or replace table `the-field-448907-r6`.`my_imdb`.`top_countries_highly_rated_movies`
      
    
    

    OPTIONS(
      description="""Identifies which countries produce the most highly-rated movies in each genre."""
    )
    as (
