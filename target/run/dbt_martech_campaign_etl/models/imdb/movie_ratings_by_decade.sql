    ...
    create or replace table `the-field-448907-r6`.`my_imdb`.`movie_ratings_by_decade`
      
    
    

    OPTIONS(
      description="""Analyzes how movie ratings change over time by grouping movies by decade."""
    )
    as (
